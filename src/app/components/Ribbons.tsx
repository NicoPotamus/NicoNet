...
const Ribbons: React.FC = () => {
  useEffect(() => {
        ...
        window['Ribbons'] = function() {
          ...
          const random = function() {
            if (arguments.length === 1) {
              ...
              const array = [arguments[0], arguments[1], arguments[2], arguments[3]];
          ...
          const Factory = function(this: any, options: any) {
            this._canvas = null;
            this._context = null;
            this._sto = null;
            this._width = 0;
    ...
    return () => {
      ...
      if (window['Ribbons'] && window['Ribbons']._onResize) {
        window.removeEventListener('resize', window['Ribbons']._onResize);
        window.removeEventListener('scroll', window['Ribbons']._onScroll);
      }
    };
  }, []);
