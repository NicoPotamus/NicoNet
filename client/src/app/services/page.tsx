          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-4">Modern Web Development</h3>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-4">UI/UX Development</h3>
                <p className="text-gray-600 mb-4">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="bg-yellow-100 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                  <Database size={28} className="text-yellow-600" />
                </div>
                <h3 className="text-xl font-bold mb-4">Database & API Development</h3>
                <p className="text-gray-600 mb-4">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="bg-cyan-100 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                  <Cloud size={28} className="text-cyan-600" />
                </div>
                <h3 className="text-xl font-bold mb-4">Web Performance</h3>
                <p className="text-gray-600 mb-4">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-4">Development & Integration</h3>
                <p className="text-gray-600 mb-4">
